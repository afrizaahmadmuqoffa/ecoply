...
const profileHref = '/recycler/profile'
...
export default function RecyclerSidebar({ userName, verificationStatus, onNavigate }: Props) {
      ...
      <div className="border-t border-border">
        ...
        <div className="px-4 py-3 border-t border-border">
          <form action={signOut}>
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-2 px-3 py-2 rounded-lg border border-border text-xs font-semibold text-muted hover:border-sage hover:text-sage-dark hover:bg-canvas transition-all"
            >
