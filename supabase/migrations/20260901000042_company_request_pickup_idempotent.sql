-- ============================================
-- Durable re-declare: Company "Request Pickup" dua arah
-- IDEMPOTENT — aman dijalankan walau 20260901000039 sudah pernah jalan.
-- Menjamin: RPC browse recycler + policy RLS agar company bisa
-- insert marketplace_bids dengan initiator='company' ke recycler target,
-- dan recycler bisa melihat + accept/reject request tersebut.
-- ============================================

-- ------------------------------------------------------------
-- 1. RPC: Get Recyclers Within Radius (untuk company browse recycler)
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- 2. RLS: Company boleh lihat recycler & recycler_details
-- (diperlukan browse recycler page)
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- 3. RLS: Company boleh insert bid/request dengan initiator='company'
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- 4. RLS: Recycler bisa lihat request yang ditujukan ke mereka
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- 5. RLS: Recycler bisa accept/reject request (initiator='company')
-- ------------------------------------------------------------
